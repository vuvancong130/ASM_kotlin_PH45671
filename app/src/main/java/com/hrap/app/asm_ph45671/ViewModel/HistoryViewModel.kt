...
class HistoryViewModel : ViewModel() {
    ...
    fun addHistory(id: String, paymentMethod: String, products: List<CartData>, totalAmount: Double, date: String) {
        ...
        products.forEach { cartItem ->
            currentList.add(
                HistoryData(
                    ...
                    product = cartItem, // Thông tin sản phẩm từ CartData
...
//        return historyItems.value?.firstOrNull { it.id == orderId } ?: HistoryData()  // Trả về dữ liệu đơn hàng
//    }
}